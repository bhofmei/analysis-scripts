...
class TransitionBaumWelchBin:
	
	def __init__( self, df, transMatAr, iter=10, ignoreAr=None ):
		# bin-wise improve transition matrices
		...
		self.transitions = transMatAr # array
		self.maxIter = iter
