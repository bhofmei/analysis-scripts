...
# Usage: python3 region_methyl_site.py [-h] [-q] [-z] [-m] [-o=out_id] <pos_file> <bed_file> <allc_file>

def processInputs( allcFileStr, bedFileStr, posFileStr, outID, isMerge, isCompress, isPrint ):
	if isPrint:
...
def parseInputs( argv ):
	...
	processInputs( allcFileStr, bedFileStr, posFileStr, outID, isMerge, isCompress, isPrint )

def printHelp():
	print('Usage: python3 region_methyl_site.py [-h] [-q] [-z] [-m] [-o=out_id] <pos_file> <bed_file> <allc_file>')
